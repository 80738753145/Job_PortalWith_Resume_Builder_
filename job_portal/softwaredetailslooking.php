    ...
    <section>
            <div class="container">
                ...
                <div class="job-details1">
                    <p><strong>Eligible Courses : </strong><?php echo htmlspecialchars($job['courses']); ?></p>
                </div><br>
                ...
                <div class="job-details2">
                    <p><strong>Eligible Criteria : </strong> <?php echo htmlspecialchars($job['criteria']); ?></p>
                </div><br>
               
                <div class="job-details3">
                    <p><strong>Job Description:</strong><br> <?php echo htmlspecialchars($job['description']); ?></p>
                </div><br>
                </div>
                <div class="job-box">  
