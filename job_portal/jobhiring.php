...
if (isset($_POST["submit"])) {
    ...
    if (isset($_FILES['image_file']) && $_FILES['image_file']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($tempfile, $folder)) {
            ...
            $query = "INSERT INTO jobhiring (image_file, jobname, category, company, location, salary, description, vacancies, nature, submission)
                      VALUES ('$folder', '$jobname', '$category', '$company', '$location', '$salary', '$description', '$vacancies', '$nature', '$submission')";
